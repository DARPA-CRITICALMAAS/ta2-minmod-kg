...
from minmodkg.typing import IRI, CleanedNotEmptyStr, Confidence
...
class CandidateEntity(RDFModel):
    ...
    source: Annotated[CleanedNotEmptyStr, P()]
    confidence: Annotated[Confidence, P()]
    observed_name: Annotated[Optional[CleanedNotEmptyStr], P()] = None
